...
- **Wrong base URL:** Use `https://api.cloud.flexprice.io` (or your tenant host) including scheme; the SDK does not add `/v1` automatically in all paths—check the host you pass to `flexprice.New`.
