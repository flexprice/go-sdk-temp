...
func main() {
    ...
    res, err := s.Workflows.QueryWorkflow(ctx, components.WorkflowExecutionFilter{})
    if err != nil {
        log.Fatal(err)
    }
...
| `request`                                                                                | [components.WorkflowExecutionFilter](../../models/components/workflowexecutionfilter.md) | :heavy_check_mark:                                                                       | The request object to use for the request.                                               |
