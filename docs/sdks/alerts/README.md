...
func main() {
    ...
    res, err := s.Alerts.QueryAlertLog(ctx, components.AlertLogFilter{})
    if err != nil {
        log.Fatal(err)
    }
...
| `request`                                                              | [components.AlertLogFilter](../../models/components/alertlogfilter.md) | :heavy_check_mark:                                                     | The request object to use for the request.                             |
