...
| `Summaries`                                                                | [][types.DtoCustomerInvoiceSummary](../types/dtocustomerinvoicesummary.md) | :heavy_minus_sign:                                                         | summaries contains the invoice summaries for each currency                 |