...
func newCustomerPortal(rootSDK *FlexPrice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CustomerPortal {
...
func (s *CustomerPortal) GetPortalExternalID(ctx context.Context, externalID string, opts ...operations.Option) (*components.DtoPortalSessionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/portal/{external_id}", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DtoPortalSessionResponse
